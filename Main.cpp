...
int main() {
	...
	////  исходна€ матрица в разреженном строчно-столбцовом формате
	//int nb;
	////int* ig = NULL;
	//int* jg = NULL;
	//double* di = NULL;
	...
	//// матрица, сконвертированна€ в разреженный строчный формат
	//MKL_INT64* ia = NULL;
	//MKL_INT64* ja = NULL;
	//double* a = NULL;

	//// nb
	//Read_Long_From_Txt_File("test_pardiso/kuslau2", &nb);

	//// ig
	//int* ig = new int[nb + 1];
	//Read_Bin_File_Of_Long("test_pardiso/ig", ig, nb + 1, 1);
	//for (i = 0; i < nb + 1; i++)
	//{
	//	ig[i]--;
	//}
	...
	//// jg
	//jg = new int[ig_n_1];
	//Read_Bin_File_Of_Long("test_pardiso/jg", jg, ig_n_1, 1);
	//for (i = 0; i < ig_n_1; i++)
	//{
	//	jg[i]--;
	//}
	...
	//// di
	//di = new double[nb];
	//Read_Bin_File_Of_Double("test_pardiso/di", di, nb, 1);

	//// ggl
	//ggl = new double[ig_n_1];
	//Read_Bin_File_Of_Double("test_pardiso/gg", ggl, ig_n_1, 1);

	//// pr
	//b = new double[nb];
	//Read_Bin_File_Of_Double("test_pardiso/pr", b, nb, 1);

	//// конвертирование в CSR
	//FromRSFToCSR_Real_1_Sym(nb, ig, &sz_ia, &sz_ja);

	//ia = new MKL_INT64[sz_ia];
	//ja = new MKL_INT64[sz_ja];
	//a = new double[sz_ja];
