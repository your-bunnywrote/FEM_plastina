...
public:
	...
	Curve();
	// по умолчанию (без указани€ типа) крива€ - лини€, у которой всегда есть начало и конец, поэтому конструктор по умолчанию на входе получает две точки - начало и конец, а также номер
